...
metadata {
  definition (name: "Z-Wave Door/Window Sensor Doorbell", namespace: "smartthings", author: "SmartThings") {
  ...
  tiles {
    standardTile("contact", "device.contact", width: 2, height: 2) {
      state "open", label: 'Default', icon: "st.Home.home30", backgroundColor: "#B0E0E6"
      state "closed", label: 'Pushed', icon: "st.Home.home30", backgroundColor: "#53a7c0"
    }
...
def sensorValueEvent(value) {
  ...
  if (device.currentValue("button") != "closed") {
    ...
    sendEvent( name : "contact", value : "closed", descriptionText: "$device.displayName was pressed")
...
void releaseButton() {
  ...
  createEvent(name: "contact", value: "open", descriptionText: "$device.displayName was released")
  sendEvent( name : "contact", value: "open", descriptionText: "$device.displayName was released")
}
